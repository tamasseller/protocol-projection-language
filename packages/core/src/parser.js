...
function peg$parse(input, options) {
  ...
  const peg$c14 = "u32";
  const peg$c15 = "=";
  const peg$c16 = "return";
  const peg$c17 = "break";
  const peg$c18 = "continue";
  const peg$c19 = "+=";
  const peg$c20 = "-=";
  const peg$c21 = "*=";
  const peg$c22 = "/=";
  ...
  const peg$e14 = peg$literalExpectation("u32", false);
  const peg$e15 = peg$literalExpectation("=", false);
  const peg$e16 = peg$literalExpectation("return", false);
  const peg$e17 = peg$literalExpectation("break", false);
  const peg$e18 = peg$literalExpectation("continue", false);
  ...
  const peg$e48 = peg$literalExpectation("0x", true);
  const peg$e49 = peg$classExpectation([["0", "9"], ["a", "f"], ["A", "F"]], false, false, false);
  const peg$e50 = peg$classExpectation([["0", "9"]], false, false, false);
  const peg$e51 = peg$classExpectation([["a", "z"], ["A", "Z"], "_"], false, false, false);
  ...
  function peg$f12(id, expr) {    return expr;  }
  function peg$f13(id, init) {    
         return { 
  ...
  function peg$f15() {    return { type: "BreakStatement" };  }
  function peg$f16() {    return { type: "ContinueStatement" };  }
  function peg$f17(expression) {    
         return { type: "ExpressionStatement", expression }; 
  }
  function peg$f18(left, operator, right) {    
