/**
 * @ppl/codecs/test — Type tree wire encoding (engine/type-tree-wire.ts,
...
import { decodeTypeTree, encodeTypeTree } from "../src/engine/type-tree-wire"
...
{
    // Mirrors packages/example/src/schema.ts's TelemetryPacket shape
    ...
    // bitfield) — this package doesn't depend on @ppl/example, so the
    // shape is reproduced here rather than imported.
