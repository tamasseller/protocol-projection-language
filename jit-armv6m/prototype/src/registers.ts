/**
 * @ppl/jit-armv6m-prototype — register assignment (docs/design.md §3)
 *
...
export const ACC_REG = 0 // r0 — acc (docs/design.md §3: matches AAPCS's own
 ...
 *  purely as the register-role record docs/design.md §3 keeps. */
