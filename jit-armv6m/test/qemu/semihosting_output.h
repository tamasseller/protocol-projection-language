...
// exit code back to the host — the mechanism jit-armv6m.md's plan
// documented as the way to get genuine automated pass/fail out of the
// qemu-test Make target, rather than eyeballing console output.
