// Adapted from tamasseller/sdvm, jit-prototyping branch, jit/armv6.h
// (same author's own prior prototype) — instruction-encoding logic is
// otherwise unchanged from that source.
