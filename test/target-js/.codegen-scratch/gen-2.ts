...
function encode_proc0(v0: Result, ctx: Ctx): void {
    ...
    switch (tagOf(v0.variant, ["ok","err"])) {
        case 0: {
            encode_proc1((v0 as Extract<Result, { variant: "ok" }>).value, ctx);
            break
        }
        case 1: {
            encode_proc2((v0 as Extract<Result, { variant: "err" }>).value, ctx);
            break
        }
        default: {
            break
