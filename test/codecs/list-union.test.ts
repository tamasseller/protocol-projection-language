/**
 * src/codecs/test — codec extension: list + union opcodes (Phase A)
 *
...
import { list, u8, union, unit, buildTypeGraph } from "../../src/core/index"
import { bare, brTable, CONST, STORE, LOAD, PUSH, opImm, validateProgram, run } from "mog-core"
import { callCodecInstr, callCodecNextInstr, countInstr, loadValInstr, openListInstr, readInstr, storeValInstr, tagInstr, writeInstr } from "../../src/codecs/engine/codec-ext-instr"
