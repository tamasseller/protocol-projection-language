/**
 * src/codecs/test — createCodecResolver(): the one generic on-demand
...
import { u8, struct, list } from "../../src/core/index"
import type { IntegerPattern } from "../../src/core/index"
import { pInteger, pList, pStructFields, pStar } from "../../src/core/index"
import { ir, lowerProgram, run, isCallInstr } from "mog-core"

import { createCodecResolver, codecRule } from "../../src/codecs/engine/resolver"
