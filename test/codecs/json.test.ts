/**
 * src/codecs/test — json.ts: encoder-only pretty-printed JSON
 */

import { describe, test } from "node:test"
import assert from "node:assert/strict"

import { struct, union, unit, list, i16, u8, buildTypeGraph } from "../../src/core/index"
import { validateProgram, run } from "mog-core"

import { buildJsonEncoder } from "../../src/codecs/components/json"
