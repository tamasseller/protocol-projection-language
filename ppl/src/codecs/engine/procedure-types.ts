/**
 * codecs — Recovering per-procedure types without `header`
 *
...
import { buildTypeGraph, SemanticTypeKinds } from "../../core/index"
import type { Correspondence, CorrespondenceEdge } from "../../core/index"
