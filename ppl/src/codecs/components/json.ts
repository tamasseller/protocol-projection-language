/**
 * codecs — Encoder-only pretty-printed JSON
 *
...
import type { IntegerMatch, IntegerPattern, UnitPattern, SemanticType, ListMatch, StructFieldsMatch, UnionFieldsMatch } from "../../core/index"
import { concreteKindOf, SemanticTypeKinds, pInteger, pUnit, pList, pUnionFields, pStructFields, pStar } from "../../core/index"
