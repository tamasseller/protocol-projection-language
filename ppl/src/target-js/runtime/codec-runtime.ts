/**
 * target-js — Runtime support for compiled codec functions
 *
 ...
 * field/variant *name* at generation time (`codecs`'s
 * `resolveHandleTypes`) — and, unlike `codecs`'s own interpreter
