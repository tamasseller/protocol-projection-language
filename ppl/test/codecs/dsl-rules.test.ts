/**
 * src/codecs/test — codecRules(): the `ir\`...\`` DSL surface for codec ops
 *
...
import { struct, union, unit, u8, list, buildTypeGraph } from "../../src/core/index"
...
import type { Handle, Direction } from "../../src/codecs/engine/codec-extension"
