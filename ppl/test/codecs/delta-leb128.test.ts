/**
 * src/codecs/test — delta-leb128.ts (codec-extension.md §8.6)
 */

import { describe, test } from "node:test"
import assert from "node:assert/strict"

import { list, struct, u8, u32, buildTypeGraph } from "../../src/core/index"
import { validateProgram, run } from "mog-core"

import { buildDeltaLeb128ListCodec, deltaLeb128EncodeRule, deltaLeb128DecodeRule } from "../../src/codecs/components/delta-leb128"
