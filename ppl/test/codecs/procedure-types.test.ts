/**
 * src/codecs/test — resolveProcedureTypes (engine/procedure-types.ts)
 *
...
import { resolveProcedureTypes, correspondenceChild, correspondenceElement, resolveHandleCorrespondences } from "../../src/codecs/engine/procedure-types"
import type { CodecExtInstr } from "../../src/codecs/engine/codec-ext-instr"
import { struct, union, list, integer, u8, named, optional, buildTypeGraph, reconcile } from "../../src/core/index"
import type { SemanticType, ConcreteSemanticType, TypeNode, Correspondence } from "../../src/core/index"
