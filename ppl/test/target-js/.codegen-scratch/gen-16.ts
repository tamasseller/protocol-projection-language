...
export class MutablePoint {
  x: number = undefined as any;
  y: number = undefined as any;
}

// proc 0: struct
function encode_proc0(v0: MutablePoint, ctx: Ctx): void {
...
// proc 0: struct
function decode_proc0(ctx: Ctx): MutablePoint {
    let v0: any = new MutablePoint();
...
export function encodePoint(value: MutablePoint): Uint8Array {
...
export function decodePoint(bytes: Uint8Array): MutablePoint {
