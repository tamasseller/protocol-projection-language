/**
 * target-js — Opt-in alternative TS representations
 *
 ...
 * specific type shape, in the same spirit as `codecs`'s
 ...
 * (`src/core/metamodel.ts`) constructs, never a generic union.
 */
import type { TypeNode } from "../../core/index"
import { child, nameOf as declaredNameOf } from "../../core/index"
import { pInteger, pUnit, pStar, pList, pUnion, pStructFields, pUnionFields } from "../../core/index"
